-- Update the anesthesia assistant system prompt with the new detailed medical protocol
UPDATE public.system_prompts 
SET content = '🧠 PROMPT DE SISTEMA – MODELO DE VALORACIÓN PREOPERATORIA
...
Uso de anticoagulantes o antiagregantes → notificación automática al administrador', 
    updated_at = now()
WHERE name = 'anesthesia_assistant';